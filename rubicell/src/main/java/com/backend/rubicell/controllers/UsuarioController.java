...
public class UsuarioController {
    ...
    public ResponseEntity<?> show(@PathVariable Long id){
        Optional<UsuarioDto> uo = service.findById(id);
        if(uo.isPresent()){
            return ResponseEntity.ok(uo.orElseThrow());
        }
    ...
    public ResponseEntity<?> update(@Valid @RequestBody UsuarioRequest usuario, BindingResult result, @PathVariable Long id){
        ...
        Optional<UsuarioDto> o = service.update(usuario, id);
        if(o.isPresent()){
    ...
    public ResponseEntity<?> remove(@PathVariable Long id){
        Optional<UsuarioDto> o = service.findById(id);
        if(o.isPresent()){
            service.remove(id);
