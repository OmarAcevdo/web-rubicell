                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <Link to="/dashboard/users"
                                ...
                                <span className="flex-1 ml-3 whitespace-nowrap">Informe de suarios</span>
                            </Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <a
                                ...
                                <span onClick={logoutClick} className="flex-1 ml-3 whitespace-nowrap">Sign Out</span>
                            </a>
                        </li>
